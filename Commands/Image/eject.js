...
$onlyIf[$mentioned[1]!=;{attachment:eject.png:https://vacefron.nl/api/ejected?name=$replaceText[$username[$clientID]; ;+]&impostor=$randomText[true;false]&crewmate=darkgreen}
